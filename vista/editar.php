...
<head>
    ...
    <title>Editar Productos Gstore</title>
</head>
<body>
    ...
    <section class="container">
        ...
        <!-- Se crea la tabla con la información de los productos -->
        <div class="text-light">
            <form action="editar_propiedades.php" method="POST">	
                <?php crearTablaEliminar(); ?>
                <br>
                <!-- Botón para editar el producto seleccionado con el botón de radio -->
