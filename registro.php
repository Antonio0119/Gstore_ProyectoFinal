...
<body>
    ...
    <section class="container">
        <form class="registro" action="control/control_registro.php" method="POST">
            <h2>Registro</h2>
            <br>
            <?php
            ...
            if(isset($_GET['error']) && $_GET['error']==true){
                print('<span style="color:red;">Error: Nombre de usuario se encuentra registrado.</span><br><br>');
            }
            ?>
            ...
            <input class="btn btn-primary" type="submit" name="enviar" value="Registrarse">
        </form>
    </section>
